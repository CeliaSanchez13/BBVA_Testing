...
describe("Test TextFieldMui", () => {
  ...
  test('renders TextField with correct label', () => {
    ...
    test('updates state when value changes', () => {
      ...
      fireEvent.change(textField, { target: { value: 'John Doe' } }); // Simula un cambio en el valor del TextField, asigna JHON DOE
  ...
  test('renders TextField with correct placeholder', () => {
    ...
    const textField = screen.getByPlaceholderText(/enter your username/i); //Otra manera de acceder con el placeholder
  ...
  test('renders TextField with error state', () => {
    ...
    const helperText = screen.getByText(/username is required/i); //Otra forma de acceder, directamente por el texto
